...
<head>
    ...
    <title>Learning - Teacher Login</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Learning</span>
                        </h4>
                        <p class="text-muted">Before entering the teacher's page, you must first log in as
                            Teacher. Please fill in the data below to continue.</p>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/ss.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold text-white">Welcome, Teacher!</h1>
                                <h5 class="font-weight-normal text-muted-transparent text-white">Please log in to
                                    entered into
                                    teacher page.</h5>
                            </div>
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb" target="_blank" href="https://syauqizaidan.github.io/">Andriyani</a> - Image by <a class="text-light bb" target="_blank" href="https://unsplash.com">Unsplash</a>
                        </div>
                    </div>
                </div>
            </div>
