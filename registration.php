...
<head>
    ...
    <title>Learning - Learn Anywhere & Anytime!</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            <li class="nav-item" id="nav"><a class="nav-link" href="<?= base_url('welcome') ?>">Home page</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" href="#" data-toggle="modal" data-target="#exampleModalCenter">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <div class="row bg-registration p-3">
            ...
            <div class="col-md-6 mx-auto my-auto mt--5">
                <form action="<?= base_url('user/registration_act') ?>" method="post">
                    ...
                    <p class="terms">By registering you agree <i>privacy and terms of conditions
                            our laws </i>
                        Read more <a href="#"> disini</a></p>
                    <button type="submit" name="submit" id="btnsubmit" disabled class="btn btn-block btn-modal btn-submit">List
                        Now!</button>
                </form>
            </div>
        </div>
