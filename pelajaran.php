    ...
    <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
            <div class="banner_content text-center">
                <h2 data-aos="fade-up" data-aos-duration="1600">Lesson</h2>
                <div data-aos="fade-up" data-aos-duration="1800" class="page_link">
                    <a href="<?= base_url('welcome') ?>">Home Page</a>
                    <a href="<?= base_url('welcome/pelajaran') ?>">Lesson</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="courses_area p_40">
    <div class="container">
        <div class="main_title">
            <h2 data-aos="fade-up" data-aos-duration="1600">Lessons Available on Learning</h2>
                        ...
                        <div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                ...
                                <a href="javaScript:void(0);">
                                    <h4>Free Math Classes</h4>
                                </a>
                                <ul class="list">
                                    <li><a href="#"><i class="lnr lnr-users"></i>54</a></li>
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i>Mathematics Teacher at SMAN 1 BANYUMAS</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="grid_item wd44">
                        <div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                <a class="cat" href="#">free</a>
                                <a href="javaScript:void(0);">
                                    <h4>Free Science Classes</h4>
                                </a>
                                <ul class="list">
                                    <li><a href="#"><i class="lnr lnr-users"></i> 34</a></li>
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i> Science teacher at SMAN 1 BANYUMAS</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="grid_item wd44">
                        <div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                <a class="cat" href="#">Free</a>
                                <a href="javaScript:void(0);">
                                    <h4>Free English Classes</h4>
                                </a>
                                <ul class="list">
                                    <li><a href="#"><i class="lnr lnr-users"></i> 63</a></li>
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i> English teacher at SMAN 1 BANYUMAS</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="grid_item wd55">
                        <div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                <a class="cat" href="#">Free</a>
                                <a href="javaScript:void(0);">
                                    <h4>Free Indonesian Language Class</h4>
                                </a>
                                <ul class="list">
                                    <li><a href="#"><i class="lnr lnr-users"></i> 24</a></li>
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i> Indonesian teacher at SMAN 1 BANYUMAS</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="col-lg-3">
                <div class="course_item" data-aos="fade-left" data-aos-duration="1800">
                    ...
                    <div class="hover_text">
                        <a class="cat" href="#">Free</a>
                        <a href="javaScript:void(0);">
                            <h4>Free Islamic Religious Education Classes</h4>
                        </a>
                        <ul class="list">
                            <li><a href="#"><i class="lnr lnr-users"></i> 35</a></li>
                            <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                            <li><a href="#"><i class="lnr lnr-user"></i> Religion Teacher at SMAN 1 BANYUMAS</a></li>
                        </ul>
                    </div>
                </div>
            </div>
